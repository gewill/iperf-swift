...
final class IperfCLIIntegrationTests: XCTestCase {
    ...
    func testConcurrentSCTPRejectionDoesNotCorruptAValidRun() throws {
        ...
        // Continuously reject SCTP runners for the whole duration of the valid
        // run. Without clearing i_errno, one of these IEPROTOCOL writes would be
        // the last global write the valid run observes and would corrupt its
